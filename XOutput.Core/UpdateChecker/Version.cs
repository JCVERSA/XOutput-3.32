...
namespace XOutput.UpdateChecker
{
    ...
    {
        /// <summary>
        /// Current application version. Single source of truth for the in-app
        /// version; the CI workflow stamps the assembly version with the same
        /// value via -p:Version (see .github/workflows/build.yml).
        /// </summary>
        public const string AppVersion = "3.32";
